...
// ---------------------------------------------------------------------------
//  Button panel geometry + colours (PB86-A1 / A2)
// --------------------------------------------------------------------------

#define COL_RED_ON     0xF800   // lit red
#define COL_RED_OFF    0x4000   // dark red
#define COL_GRN_ON     0x07E0   // lit green
#define COL_GRN_OFF    0x0200   // dark green

// ---- Point these at your real Parameters.h names --------------------------
#define P_glideOnOff    P_glideSW
#define P_holdSW        chordHoldSW    // middle-row Hold toggle - CHECK

// Lower/Upper button pair - independent of the upperSW/lowerSW colour switch.
// 0 = lower lit, 1 = upper lit.
