...
Knob knobs[NUM_KNOBS] = {
  CENTRE_RANGE( CCosc1PW,               P_osc1PW,               "PW %",  1, 99, "" ),
  KNOB(         CCosc1SawLevel,         P_osc1SawLevel,         "SAW L" ),
  KNOB(         CCosc1PulseLevel,       P_osc1PulseLevel,       "SQR L" ),
  KNOB(         CCosc1TriangleLevel,    P_osc1TriangleLevel,    "TRI L" ),

  KNOB(         CCosc1PWM,              P_osc1PWM,              "PW LFO" ),
  KNOB(         CCosc1sawDetune,        P_osc1sawDetune,        "S DET" ),
  KNOB_RANGE(   CCosc1sawCount,         P_osc1sawCount,         "S CNT", 1, 5, "" ),
  EMPTY_SLOT,

  KNOB(         CCosc1envPWM,           P_osc1envPWM,           "PW ENV" ),
  KNOB(         CCdriftDepth,           P_driftDepth,           "DRIFT" ),
  EMPTY_SLOT,
  EMPTY_SLOT,
};
