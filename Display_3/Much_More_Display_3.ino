...
Knob knobs[NUM_KNOBS] = {
  CENTRE_RANGE( CCosc2PW,         P_osc2PW,         "PW %",  1, 99, "" ),
  KNOB(         CCosc2SawLevel,   P_osc2SawLevel,   "SAW L" ),
  KNOB(         CCosc2PulseLevel, P_osc2PulseLevel, "SQR L" ),
  KNOB(         CCosc2SubLevel,   P_osc2SubLevel,   "SUB L" ),

  KNOB(         CCosc2PWM,        P_osc2PWM,        "PW LFO" ),
  CENTRE(       CCosc2Detune,     P_osc2Detune,     "DET" ),
  CENTRE_RANGE( CCosc2Interval,   P_osc2Interval,   "INT", -12, 12, "" ),
  EMPTY_SLOT,

  KNOB(         CCosc2envPWM,     P_osc2envPWM,     "PW ENV" ),
  KNOB(         CCosc2EnvDepth,   P_osc2envDepth,   "PT ENV" ),
  EMPTY_SLOT,
  EMPTY_SLOT,
};
