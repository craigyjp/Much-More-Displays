...
Knob knobs[NUM_KNOBS] = {
  EMPTY_SLOT,
  KNOB(         CCfmDepth,        P_fmDepth,        "FM" ),
  KNOB(         CCATDepth,        P_ATDepth,        "AT P" ),
  KNOB(         CCvcfATDepth,     P_vcfATDepth,     "AT V" ),

  EMPTY_SLOT,
  KNOB_RANGE(   CCPitchBend,      P_PitchBendLevel, "PB", 0, 12, "" ),
  KNOB(         CCMWDepth,        P_modWheelDepth,  "MW" ),
  EMPTY_SLOT,

  EMPTY_SLOT,
  KNOB(         CCamDepth,        P_amDepth,        "AM" ),
  KNOB(         CCvolumeControl,  P_volumeControl,  "VOL" ),
  EMPTY_SLOT,
