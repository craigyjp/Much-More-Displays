...
Knob knobs[NUM_KNOBS] = {
  KNOB(CCeffectPot1, P_effectPot1, "POT 1"),
  KNOB(CCeffectPot2, P_effectPot1, "POT 2"),
  KNOB(CCeffectPot3, P_effectPot1, "POT 3"),
  EMPTY_SLOT,

  CENTRE(CCeffectsMix, P_effectsMix, "FX MIX"),
  EMPTY_SLOT,
  EMPTY_SLOT,
  EMPTY_SLOT,
...
void renderCurrentPatchPage() {
  ...
  tft.fillRoundRect(10, 210, 310, 30, 5, getActiveColor());
  tft.setCursor(50, 233);
  tft.print(buf1);
  tft.setCursor(180, 233);
  tft.print(buf2);

  tft.fillRoundRect(260, 10, 60, 30, 5, getActiveColor());  // Green box for off
  tft.setCursor(270, 33);
  tft.print("B:");
  tft.setCursor(300, 33);
  tft.print(panelData[P_effectBank] + 1);

  tft.fillRoundRect(260, 50, 60, 30, 5, getActiveColor());  // Green box for off
  tft.setCursor(270, 73);
  tft.print("P:");
  tft.setCursor(300, 73);
  tft.print(panelData[P_effectNum] + 1);
  tft.setFreeFont(&FreeSans12pt7b);

  tft.fillRoundRect(120, 90, 200, 30, 5, TFT_GREEN);  // Green box for off
  tft.setCursor(130, 113);
  tft.print("P1: ");
  tft.print(buf3);

  tft.fillRoundRect(120, 130, 200, 30, 5, TFT_GREEN);  // Green box for off
  tft.setCursor(130, 153);
  tft.print("P2: ");
  tft.print(buf4);

  tft.fillRoundRect(120, 170, 200, 30, 5, TFT_GREEN);  // Green box for off
